#!/usr/bin/env python3
"""Freeze system-corrected V1R2 token-validity audit."""
...
RUN_ID = "gate3_20260829_gse_token_validity_action_track_feasibility_v1r2_seed0"
SPEC = PROJECT_ROOT / "configs/v3/gate3/gse_token_validity_action_track_feasibility_v1r2.json"
DATA_CARD = "configs/v3/gate3/data_cards/gse_token_validity_action_track_feasibility_v1r2.json"
...
def main() -> int:
    if SPEC.exists():
        raise RuntimeError("token-validity V1R2 spec already exists")
    ...
    failed = "results/gate3_semantics/gate3_20260829_gse_token_validity_action_track_feasibility_v1r_seed0"
    inputs = [
        DATA_CARD,
    ...
    tools = {
        ...
        "freezer": "tools/v3/freeze_gse_token_validity_action_track_feasibility_spec_v1r2.py",
    ...
    spec = {
        "schema_version": "v3_run_spec_v1", "gate": 3, "execution_phase": 3, "date": "20260829", "slug": "gse_token_validity_action_track_feasibility_v1r2", "seed": 0,
        ...
        "method": "System-corrected V1R2 with unchanged science; accepts outer or already-inner sealed summaries, then performs the same tied-threshold validity audit.",
        ...
        "user_authorization": {"status": "APPROVED", "approved_by": "user-standing-authorization", "approved_at": "2026-08-29T01:45:00+08:00", "authorized_gates": [3], "authorized_operations": ["audit"], "scope": "One immutable system-corrected V1R2 zero-training C01-C08 audit.", "confirmation_reference": "User explicitly delegated best-method choices and continuous execution."},
