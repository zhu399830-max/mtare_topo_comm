...
INVENTORY='configs/v3/gate3/calibration_route_inventory_v1.json'
INVENTORY_SHA='14967735135c6da03111d9f580846531f29264b7430dba7ccfa570c97306dca8'
...
def compile_scope(root):
    ...
    if len(missing)!=262 or any(r['split']!='calibration' or '_C07__' not in r['task'] for r in missing):
        raise ValueError('exact262 C07 calibration required')
    ...
    return dict(schema='calibration_missing262_input_scope_v1',status='METADATA_ONLY_NOT_EXPORT_AUTHORITY',
        ...
        restrictions=['six_student_fields_only','calibration_not_fit','no_labels_or_training','no_rerender',
                      'old27_inputs_reused_separately','shared_chunk_rows_not_new_samples'])
