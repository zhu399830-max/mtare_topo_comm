...
def compile_scope(root):
    ...
    joined=json.loads(read('docs/figures/gse_graph/calibration_opposite_join_check_20260909.json',
                          '06a8e2beecb3479148bb15fb74303b1eae86ed9ef8a8fb856b3cf74f2f826589'))
    base=json.loads(read('configs/v3/gate3/calibration_opposite_input_scope_v1.json',
                        '34486d834aeed55a5c62db0d5e29eb2f4fddb5ff031ffdf877fc0ffa674ecf8f'))
    ...
    return dict(schema='calibration_opposite289_teacher_scope_v1',status='METADATA_BOUND_NOT_EXECUTION',entries=entries,
