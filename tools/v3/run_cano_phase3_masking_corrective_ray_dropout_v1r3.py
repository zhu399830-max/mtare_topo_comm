...
RUN_ID="gate2_20260812_cano_phase3_masking_corrective_ray_dropout_v1r3_seed0"
...
def main()->int:
    ...
    probe="import json,numpy,zarr,numcodecs,sklearn,torch;print(json.dumps({'torch':torch.__version__,'cuda':torch.version.cuda,'gpu':torch.cuda.get_device_name(0),'zarr':zarr.__version__,'numcodecs':numcodecs.__version__,'numpy':numpy.__version__,'sklearn':sklearn.__version__,'cuda_available':torch.cuda.is_available()}))";identity=probe_environment_identity(run,probe)
