"""Single source-support correction; no change to sectors, weights or matching."""
import argparse
from pathlib import Path
import run_direction_task_witness_replay as runner
from mtare_topo.semantics.observed_direction_proposals import range_proposals

runner.NAME='gse_direction_task_witness_replay_v2'
...
runner.SUPPORT_POLICY='exact_detector_connected_columns_v2'
