"""One preregistered window-domain/set-loss correction; no original run retry."""
import synthetic_fit_v1 as base
from mtare_topo.governance_synthetic_window_fit import SCHEMA,SLUG,validate_card,compile_scope
...
base.RUN='results/gate3_semantics/gate3_20260908_'+SLUG+'_seed0';base.ENTRY='tools/v3/synthetic_window_fit_v1.py'
