"""Exact860 partial-reference paired diagnostic, not complete detector authority."""
from pathlib import Path
from bidirectional_paired_scope_v1 import compile_scope
from mtare_topo.governance_surface_selection import digest

SCHEMA='v3_bidirectional_relation_train_card_v1'
SLUG='gse_bidirectional_relation_train_v1'
POLICY=dict(methods=['c0','c1'],seed=0,updates_per_method=2000,microbatch=1,accumulation=4,
            ...
            empty_supervision_policy='keep all282 fit observations;2000 scheduled batches; skip optimizer only when all four observations lack supervision; log actual steps',
            advance_condition='Calibration mechanism signal only: C1 reference branch recall at least0.05 above C0; known branchFP and unresolved not higher; nodeTP not lower and known nodeFP not higher. No independent generalization or graph claim; no automatic expansion.')
