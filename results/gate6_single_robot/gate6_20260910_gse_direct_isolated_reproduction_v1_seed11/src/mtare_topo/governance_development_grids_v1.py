"""Exact existing307 observation-grid export, no model or semantic labels."""
from mtare_topo.governance_surface_selection import digest

SCHEMA = 'v3_development_grids_card_v1'
SLUG = 'gse_development_grids_v1'
SCOPE_SHA = 'd5c46308e588c5a4c84c6d2410468e078e4f8794938b1cb3b987d1a6e920d5ac'
...
def validate_card(card):
    ...
    if digest(card['scope']) != SCOPE_SHA or card['scope_sha256'] != SCOPE_SHA:
        errors.append('exact307 selection/read policy drift')
    a = card['approval']
