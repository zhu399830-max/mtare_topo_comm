...
SCHEMA = 'v3_training_join_probe_card_v2'
SLUG = 'gse_training_join_probe_v2'
...
POLICY = dict(task='S01_flat_tree_small_C01__c1_mixed',sequence=225,extra_range_error_m=0.,radius_m=10.,wall_time_s=1800, host_ram_bytes=4294967296, output_bytes=536870912,
              gpu_bytes=1073741824, labels=0, optimizer_steps=0, no_retry=True, joined_observations=1, opening_interface_radius_m=1., predictions_are_model_outputs=False)
