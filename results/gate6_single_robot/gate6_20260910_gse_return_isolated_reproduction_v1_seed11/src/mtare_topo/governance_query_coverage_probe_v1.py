...
SCHEMA = 'v3_query_coverage_probe_card_v1'
SLUG = 'gse_query_coverage_probe_v1'
...
POLICY = dict(task='S01_flat_tree_small_C01__c1_mixed',sequence=225,extra_range_error_m=0.,radius_m=10.,wall_time_s=1800, host_ram_bytes=4294967296, output_bytes=536870912,
              gpu_bytes=0, labels=0, optimizer_steps=0, no_retry=True, coordinates_per_axis_m=[-7.125,-2.125,2.125,7.125], diagnostic_radii_m=[1.,2.,4.], predictions_are_model_outputs=False)
