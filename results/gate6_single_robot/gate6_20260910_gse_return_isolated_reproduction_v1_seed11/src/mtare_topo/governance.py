        ...
        if path_error:
            ...
            if not data_card_path.is_file():
                ...
                try:
                    ...
                    if (operation == "shadow" and card.get("schema_version") in {"v3_live_geometry_shadow_card_v1", "v3_live_geometry_shadow_card_v2"}) or (operation == "closed_loop_single" and card.get("schema_version") in {"v3_live_geometry_execution_card_v1", "v3_live_geometry_execution_card_v2", "v3_live_geometry_execution_card_v3"}):
                    ...
                    elif operation == "training" and card.get("schema_version") == "v3_gse_geometry_bound_training_card_v1":
                        from mtare_topo.governance_geometry_bound import validate_geometry_bound_training_card
                        card_report = validate_geometry_bound_training_card(card)
