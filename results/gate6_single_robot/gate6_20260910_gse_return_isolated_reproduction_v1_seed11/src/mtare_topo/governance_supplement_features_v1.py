...
SCHEMA = "v3_supplement_features_card_v1"
SLUG = "gse_supplement_features_v1"
...
def validate_card(card):
    ...
    if type(scope) is not dict or scope.get("schema_version") != "gse_supplement_feature_source_plan_v1":
        return ValidationReport(False, ("compiled feature source scope required",))
    if scope.get("counts") != {"parents": 70, "tasks": 210, "observations": 2676,
            "source_frames": 13374, "splits": {"fit": 2310, "calibration": 189, "development": 177}}:
