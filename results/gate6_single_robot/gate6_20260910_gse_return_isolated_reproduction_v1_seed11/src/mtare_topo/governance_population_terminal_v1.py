...
SCHEMA='v3_population_terminal_card_v1'
SLUG='gse_population_terminal_v1'
POLICY=dict(extra_range_error_m=0., radius_m=10., wall_time_s=1800, host_ram_bytes=4294967296,
...
def validate_card(card):
    ...
    if type(s) is not dict or s.get('schema')!='gse_surface_population_teacher_scope_v1':
    ...
    for key,n in dict(parents=70,tasks=210,physical_edge_units=1120,observations=3360,
                      ...
                      input_npz_files=210,array_headers=630,source_chunk_files=4590,
                      decoded_padded_bytes=1523985984,actual_payload_reads=0,labels=0).items():
