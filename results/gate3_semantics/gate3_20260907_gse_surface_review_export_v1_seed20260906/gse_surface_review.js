...
function validateBundle(b){
  keys(b,"schema observation_id coordinate_frame source_frame_indices points_xyz_m point_history_slots");
  if(b.schema!=="gse_surface_review_bundle_v1"||b.coordinate_frame!=="current_sensor_m")throw Error("错误的单观察格式");text(b.observation_id);
...
if(typeof module!=="undefined")module.exports={SurfaceBrowserReview,validateBundle,validateTarget,emptyTarget,parseStrictJSON};
if(typeof document!=="undefined"){
  const $=id=>document.getElementById(id);let session=null,yaw=.3,pitch=.45,zoom=1,drag=null;
