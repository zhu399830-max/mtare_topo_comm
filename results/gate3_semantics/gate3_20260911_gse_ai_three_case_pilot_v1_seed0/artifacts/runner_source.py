...
def main(mode):
    ...
    if mode=='freeze':
        ...
        spec=dict(schema_version='v3_run_spec_v1',gate=3,date='20260911',slug='gse_ai_three_case_pilot_v1',seed=0,
            operation='ai_annotation',data_card=CARD,user_authorization=card['approval'],
            command=['python3','tools/v3/ai_junction_pilot.py','--begin'],
...
if __name__=='__main__':
    ...
    a=p.parse_args();main(next(k for k,v in vars(a).items() if v))
