...
from mtare_topo.teacher.gse_construction_paths_v1 import construction_incident_paths


def document():
    line=[[0,0,0],[2,0,0]]
    return dict(base_construction=dict(coordinate_frame="world",primitives=[dict(primitive_id="p",centerline_xyz_m=line)],
